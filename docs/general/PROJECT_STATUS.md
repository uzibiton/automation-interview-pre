...
- **Pattern:** `https://{service}-pr-{number}-{hash}-{region}.a.run.app`
- **Example (PR #65):**
  - Frontend: `https://expense-tracker-pr-65-buuath6a3q-uc.a.run.app`
  - Auth: `https://auth-service-pr-65-{hash}-uc.a.run.app`
  - API: `https://api-service-pr-65-{hash}-uc.a.run.app`
- **Note:** URLs are auto-generated by Cloud Run with unique hash identifiers
